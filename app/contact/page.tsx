        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto mb-16">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-700">info@stonesystems.io</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
          ...
          <div className="max-w-2xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-lg border border-gray-200">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Send Message
              </button>
            </form>
