        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
            ...
            <div className="flex-1 flex justify-center md:justify-end">
              <div className="w-72 h-72 md:w-80 md:h-80 bg-gradient-to-br from-amber-300 via-yellow-400 to-amber-500 rounded-full flex items-center justify-center shadow-2xl relative">
                ...
                <div className="absolute bottom-0 left-0 w-20 h-20 bg-amber-400 rounded-full opacity-50 blur-xl"></div>
              </div>
            </div>
          </div>
        </div>
