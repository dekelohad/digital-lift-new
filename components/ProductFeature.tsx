  ...
  return (
    <Section>
      <div className={`flex flex-col ${isImageRight ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12`}>
        ...
        <div className="flex-1">
          {children || (
            <div className="w-full h-64 md:h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center shadow-lg border border-gray-200">
              <span className="text-gray-500 font-medium">website animation</span>
            </div>
          )}
        </div>
      </div>
